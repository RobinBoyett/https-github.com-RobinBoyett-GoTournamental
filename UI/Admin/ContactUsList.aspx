    ...
    <div class="row">
        <div class="col-md-9">
	        ...
	        <asp:GridView id="ContactUsListGridView" OnRowDataBound="ContactUsListGridView_RowDataBound" EmptyDataText="No Queries Were Found" runat="server" GridLines="None" AutoGenerateColumns="False" Width="1000">
		        <Columns>
			        <asp:HyperLinkField HeaderText="ID" HeaderStyle-HorizontalAlign="Left" DataTextField="ID" ItemStyle-Font-Size="11px" ItemStyle-Width="40" DataNavigateUrlFormatString="~/UI/Admin/ContactUsView.aspx?ID={0}" DataNavigateUrlFields="ID" />
