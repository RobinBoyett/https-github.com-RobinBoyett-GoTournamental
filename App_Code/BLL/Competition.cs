...
namespace GoTournamental.BLL.Organiser {
    ...
    public class Competition: ICompetition {
        ...
        public enum AgeBands {
            ...
            [DescriptionAttribute("Under 14 Boys")] Under14Boys = 8,
            [DescriptionAttribute("Under 15 Boys")] Under15Boys = 9,
            [DescriptionAttribute("Under 16 Boys")] Under16Boys = 10,
        ...
        public enum CompetitionFormats {
            ...
            [DescriptionAttribute("Competitive League(s) With Cup Play-Off Format")] LeagueAndCup = 3,
            [DescriptionAttribute("Competitive League(s) With Cup and Plate Play-Off Format")] LeagueCupAndPlate = 4//,
            //[DescriptionAttribute("Competitive Cup Knock-Out Format")] Cup = 5
        }
