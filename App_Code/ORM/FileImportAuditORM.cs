...
namespace GoTournamental.ORM.Organiser
{
    ...
    public class FileImportAuditDbContext : DbContext
    {
        ...
        public FileImportAuditDbContext() : base(ConfigurationManager.ConnectionStrings["GoTournamentalConnection"].ConnectionString)
        {
    ...
    {
        public FileImportAuditConfiguration() : base() 
        {
            HasKey(i => i.ID);
