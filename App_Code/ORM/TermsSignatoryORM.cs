...
namespace GoTournamental.ORM.Organiser
{
    ...
    public class TermsSignatoryDbContext : DbContext
    {
        ...
        public TermsSignatoryDbContext() : base(ConfigurationManager.ConnectionStrings["GoTournamentalConnection"].ConnectionString)
        {
    ...
    {
        public TermsSignatoryConfiguration() : base()
        {
            HasKey(i => i.ID);
