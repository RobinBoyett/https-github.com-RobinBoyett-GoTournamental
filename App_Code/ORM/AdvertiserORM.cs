...
namespace GoTournamental.ORM.Organiser
{
    ...
    public class AdvertiserDbContext : DbContext
    {
        ...
        public AdvertiserDbContext() : base(ConfigurationManager.ConnectionStrings["GoTournamentalConnection"].ConnectionString) 
        {
    ...
    {
        public AdvertisementConfiguration() : base() 
        {
            HasKey(i => i.ID);
