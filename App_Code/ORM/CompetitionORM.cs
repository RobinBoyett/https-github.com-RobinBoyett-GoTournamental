...
namespace GoTournamental.ORM.Organiser 
{
    ...
    public class CompetitionDbContext : DbContext 
    {
        ...
        public CompetitionDbContext() : base(ConfigurationManager.ConnectionStrings["GoTournamentalConnection"].ConnectionString) 
        {
    ...
    {
        public CompetitionConfiguration() : base() 
        {
            HasKey(i => i.ID);
            ...
            Property(i => i.FixtureStructure).HasColumnName("FixtureStructure");
