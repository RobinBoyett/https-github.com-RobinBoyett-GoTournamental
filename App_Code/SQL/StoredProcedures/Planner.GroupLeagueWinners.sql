...
/****** Object: SqlProcedure [Planner].[GroupLeagueWinners] Script Date: 08/06/2018 08:51:34 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [Planner].[GroupLeagueWinners] (
	@GroupID		int
)
AS
...
BEGIN
	...
	SELECT TeamID, Played, Wins, Draws, Defeats, GoalsFor, GoalsAgainst, GoalDifference, Points, HiddenPoints 
	FROM #AdjustedLeagueTable
	WHERE Position = 1
